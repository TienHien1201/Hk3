...
select thamgiadt.MADT, giaovien.HOTEN from thamgiadt, giaovien
where thamgiadt.MAGV = giaovien.MAGV and giaovien.HOTEN like 'Trần%'
union
select detai.MADT, giaovien.HOTEN from giaovien, detai
where detai.GVCNDT = giaovien.MAGV and giaovien.HOTEN like 'Trần%';
